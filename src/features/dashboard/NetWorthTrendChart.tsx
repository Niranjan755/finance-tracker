  ...
  return (
    <ChartContainer config={chartConfig} className="aspect-auto h-56 w-full">
      <LineChart data={data} margin={{ left: 0, right: 8 }}>
        ...
        <ChartTooltip content={<ChartTooltipContent formatter={(value) => [formatCurrency(Number(value)), 'Net Worth']} />} />
        <Line type="monotone" dataKey="netWorthCents" stroke="var(--color-netWorthCents)" strokeWidth={2} dot={{ r: 3 }} />
      </LineChart>
    </ChartContainer>
  )
}
